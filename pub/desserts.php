...
<p class="success" id="message"></p>
    <h2>Add Dessert to menu</h2>
        <label for="dessName">Name : </label>
        <input type="text" name="dessName" placeholder="Enter name of dessert" id="dessName">
        <label for="dessDescription">Description : </label>
        <input type="text" name="dessDescription" placeholder="Describe the dessert" id="dessDescription">
        <label for="dessPrice">Price : </label>
        <input type="number" name="dessPrice" placeholder="Enter a price for the dessert" id="dessPrice">
        <input id="addDessBtn" class="loginBtn" type="submit" value="Add dessert"><br />
