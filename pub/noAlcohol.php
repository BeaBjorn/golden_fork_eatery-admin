...
<p class="success" id="message"></p>
    <h2>Add drink to menu</h2>
        ...
        <label for="noAlcName">Name : </label><br />
        <input type="text" name="noAlcName" placeholder="Enter name of drink" id="noAlcName"><br />
        <label for="noAlcPrice">Price : </label><br />
        <input type="number" name="noAlcPrice" placeholder="Enter a price the drink" id="noAlcPrice"><br />
        <input id="addNoAlcBtn" class="loginBtn" type="submit" value="Add drink"><br />
